<template>
  ...
  <div id="btn-div-grid">
    ...
    <div class="btn-div" aria-roledescription="button">
      <ion-icon :icon="chatboxOutline" color="warning" size="large"></ion-icon>
      <ion-label>Chats</ion-label>
    </div>
    <div class="btn-div" aria-roledescription="button">
      <ion-icon :icon="settingsOutline" color="warning" size="large"></ion-icon>
